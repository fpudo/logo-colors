...
class LogoColors extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  constructor(props) {
    super(props);
  }
...
const getDialog = () => {
  if (dialog == null) {
    ...
    Object(react_dom__WEBPACK_IMPORTED_MODULE_2__["render"])(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(LogoColors, { dialog: dialog }), dialog);
  }
  return dialog;
};
